          ...
          <div class="scroll-box" ref="scrollBox2" data-id="aaa" @mouseover="useStopTimer" @mouseleave="OutTimer">
            <div class="scroll-box-item" v-for="(item, index) in dataList1" :key="item.id">
              <div style="width: 53.5px; height: 35px; position: relative">
                <div style="position: absolute; color: #fff; left: 0; font-size: 40px; z-index: 999">
                  1
                </div>
                <img src="../../assets/pagefive/right3.png" alt="" style="width: 53.5px; height: 35px" />
              </div>
              <div class="ellipsis" style="width: 50%; line-height: 15px">
                {{ index + 1 }}.{{ item.staname }}
              </div>
