<template>
  <div class="leftThree">
    <div class="text1" style="padding-left: 60px">故障类型排行</div>
        ...
        <div class="box">
          <div class="scroll-box" ref="scrollBox2" data-id="aaa" @mouseover="useStopTimer" @mouseleave="OutTimer">
            <div class="scroll-box-item" v-for="(item, index) in dataList1" :key="item.id">
              <div style="width: 53.5px; height: 35px; position: relative">
                <div style="
                    position: absolute;
                    color: #fff;
                    left: 0;
                ...
                <img v-if="index == 0" src="../../assets/pagefive/right3.png" alt=""
                  style="width: 53.5px; height: 35px" />
                <img v-if="index == 1" src="../../assets/pagefive/right32.png" alt=""
                  style="width: 53.5px; height: 35px" />
                <img v-if="index == 2" src="../../assets/pagefive/right33.png" alt=""
                  style="width: 53.5px; height: 35px" />
                <img v-if="index > 2" src="../../assets/pagefive/right34.png" alt=""
                  style="width: 53.5px; height: 35px" />
              </div>
              ...
              <div style="width: 25%; margin-left: 0px; border-box: box-sizing; float: right">
                {{ item.transactionid }}
              </div>
            </div>
          </div>
