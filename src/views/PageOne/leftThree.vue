...
import { reqAreaTopDataByTerminalCount } from '@/api/pageone'
//
const data1 = [3624, 2118, 1930, 1900, 1526, 743, 665, 633, 258, 257]
const data2 = [3624, 2118, 1930, 1900, 1526, 743, 665, 633, 258, 257]
const xData = [
  '历城区',
  '槐荫区',
  '历下区',
...
const getChart = () => {
  ...
  const option = {
    ...
    xAxis: {
      ...
      axisLabel: { color: '#A5C9DB', fontSize: 12, rotate: 40 },
      axisTick: { show: false }
    },
    yAxis: {
      type: 'value',
      ...
      min: 0,
      // max: 80000,
      axisLabel: { color: '#A5C9DB', fontSize: 12 },
      splitLine: {
        lineStyle: {
...
const getData = async () => {
  const res = await reqAreaTopDataByTerminalCount()
  if (res.code === 0) {
    console.log('各区县充电终端数量', res)
    getChart()
  }
}
const value = ref('1')
